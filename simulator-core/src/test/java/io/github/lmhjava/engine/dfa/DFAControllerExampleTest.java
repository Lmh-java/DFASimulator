...
public class DFAControllerExampleTest {
    ...
    public void testMultipleBranchesToOne() throws NextNodeUndefException {
        ...
        edge1.registerAlphabet("a");
        edge1.registerAlphabet("b");
        edge1.registerAlphabet("c");
        DFAEdge edge2 = new DFAEdge(node1, node2);
        edge2.registerAlphabet("d");
        edge2.registerAlphabet("e");
        edge2.registerAlphabet("f");
        DFAEdge edge3 = new DFAEdge(node2, node1);
        edge3.registerAlphabet("e");
        edge3.registerAlphabet("f");
        edge3.registerAlphabet("g");
        edge3.registerAlphabet("h");
        DFAController controller = new DFAController();
